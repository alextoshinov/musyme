...
abstract class Kohana_Session {
	...
	public function read($id = NULL)
	{
		...
		{
			// Error.php reading the session, usually a corrupt session.
			throw new Session_Exception('Error.php reading session data.', NULL, Session_Exception::SESSION_CORRUPT);
		}
